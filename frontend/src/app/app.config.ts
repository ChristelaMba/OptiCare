...
// /admin/cabinets, /admin/utilisateurs, /rendezvous et /statistiques avec
// des données factices tant que le back-end n'est pas branché (cf.
// core/mocks/*.ts). Jamais actif en prod (environment.production === true
// fait passer chaque intercepteur en no-op). À retirer une fois l'API
// réelle disponible.
