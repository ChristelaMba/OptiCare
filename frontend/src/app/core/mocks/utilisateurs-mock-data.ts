...
export let utilisateursFactices: Utilisateur[] = [
  ...
  // --- Super Admin ---
  { id: 'user-027', role: 'super_admin', nom: 'Owona', prenom: 'Francine', email: 'f.owona@opticare.cm', telephone: '+237 6 90 00 00 01', ville: 'Douala', actif: true, dateCreation: new Date('2026-01-01T09:00:00') },
];
